<%@ Page Title="" Language="C#" MasterPageFile="~/Dorkytech.Master" AutoEventWireup="true" CodeBehind="Departamentos.aspx.cs" Inherits="Dorkytech.Departamentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridViewDepartamentos" runat="server" AllowPaging="True" CssClass="table-responsive" so CellPadding="4" AllowSorting="True" PageSize="4" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
        <Columns>
